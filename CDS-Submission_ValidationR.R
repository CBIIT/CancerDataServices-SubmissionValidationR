...
cat("\nChecks that are specific to participant metadata.\n")
...
for (participant in 1:length(participant_list)){
  ...
  if (length(gender)>1){
    cat(paste("\nThe following participant_id, ",participant_list[participant],", is linked to more than one value for gender.",sep = "" ))
  }
  if (length(ethnicity)>1){
    cat(paste("\nThe following participant_id, ",participant_list[participant],", is linked to more than one value for ethnicity.",sep = "" ))
  }
  if (length(race)>1){
    cat(paste("\nThe following participant_id, ",participant_list[participant],", is linked to more than one value for race.",sep = "" ))
  }
}
